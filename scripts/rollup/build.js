...
function getPlugins(
  ...
  return [
    ...
    // Remove 'use strict' from individual source files. LYG
    // {
    //   transform(source) {
    ...
    // Please don't enable this for anything else! LYG
    // isUMDBundle && entry === 'react-art' && commonjs(),
    // Apply dead code elimination and/or minification.
    // closure doesn't yet support leaving ESM imports intact LYG
    // isProduction &&
    //   bundleType !== ESM_PROD &&
    //   closure({
    ...
    //   }),
    // Add the whitespace back if necessary. LYG
    // shouldStayReadable &&
    //   prettier({
    //     parser: 'flow',
    //     singleQuote: false,
    ...
    //     bracketSpacing: true,
    //   }),
    // License and haste headers, top-level `if` blocks. LYG
    // {
    //   renderChunk(source) {
